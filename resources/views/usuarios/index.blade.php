         ...
         <div class="container">
            <div class="row">
               ...
               <div class="mode-switch">
                  <button id="light-mode">☀︎</button>
                  <button id="dark-mode">🌙</button>
               </div>
               <!-- Añadir esto en tu archivo blade donde quieres los botones -->

               <div class="font-switch">
                  <button onclick="changeFont('font-arial')">Arial</button>
                  <button onclick="changeFont('font-times')">Times New Roman</button>
                  <button onclick="changeFont('font-verdana')">Verdana</button>
               ...
               <style>
                  ...
                  .text-sm {
                     color: #000000;
                     /* Asumiendo que quieres texto negro por defecto */
                  }
                  ...
                  @media (prefers-color-scheme: dark) {
                     .text-sm {
                        color: purple;
                        /* Cambia el color del texto a negro en modo oscuro */
                     }
                  }

                  /* Estilo por defecto para el modo claro */
                  .read_more {
                     color: yellow;
               ...
               <script>
                  ...
                  document.addEventListener('DOMContentLoaded', () => {
                     ...
                     document.getElementById('fontArial').addEventListener('click', () => {
                        textBg.className = 'text_norlam font-arial font-family';
                     });

                     document.getElementById('fontTimes').addEventListener('click', () => {
                        textBg.className = 'text_norlam font-times font-family';
                     });

                     document.getElementById('fontVerdana').addEventListener('click', () => {
                        textBg.className = 'text_norlam font-verdana font-family';
                     });
                  });
                  ...
                  document.addEventListener('DOMContentLoaded', () => {
                     ...
                     // Tamaño inicial de la fuente en píxeles
            ...
            <div class="col-md-6">
               <div class="about_text">
                  <div class="titlepage">
                     ...
                     <p>Buscamos ser la mejor papeleria en Bolivia dando la mejor atención al cliente con los mejores precios</p>
                  </div>
               </div>
            </div>
            <div class="col-md-6">
