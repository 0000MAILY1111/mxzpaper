        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @role('Administrador')
                    <x-dropdown align="none" width="48" class="mt-8">
                        <x-slot name="trigger">
                            <x-nav-link href="#">
                    ...
                    <x-dropdown align="right" width="48" class="mt-2">
                        ...
                        <x-slot name="content">
                            <x-nav-link href="{{ route('productos.create') }}" :active="request()->routeIs('habitaciones.create')">
                                {{ __('Crear Producto') }}
                            </x-nav-link>
                    ...
                    <x-dropdown align="right" width="48" class="mt-2">
                        ...
                        <x-slot name="content">
                            <x-nav-link href="{{ route('categorias.create') }}" :active="request()->routeIs('habitaciones.create')">
                                {{ __('Crear Categoria') }}
                            </x-nav-link>

                            <x-nav-link href="{{ route('categorias.lista') }}" :active="request()->routeIs('habitaciones.lista')">
